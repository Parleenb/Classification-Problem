...
conf_full, err_full = evaluate_classifier(testlab, pred_full_nn, "Full NN")
print(f"Full NN processing time: {time_full_nn:.2f} seconds")
...
conf_cluster, err_cluster = evaluate_classifier(testlab, pred_cluster_nn, "Cluster NN")
